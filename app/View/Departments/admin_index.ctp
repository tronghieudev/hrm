...
<?php $this->Paginator->options(array(
    'url'=> array('controller' => 'departments',
    'action' => 'index',
    'admin' => true
))); ?>
...
<div class="col-xs-12 bg">
	<div style="margin-bottom: 20px;">
		<a class="btn btn-success pull-right" data-toggle="modal" href='#modal-create'>Create new Department</a>
	...
	<table class="table table-bordered table-hover">
		...
		<tbody>
		    <?php foreach($data as $item) { ?>
	            <tr id="tr<?php echo $item['Department']['id']; ?>">
	                <td><?php echo $item['Department']['id']; ?></td>
	                <td class="name"><?php echo $item['Department']['name']; ?></td>
	                <td><?= date('d-m-Y', strtotime($item['Department']['created'])); ?></td>
	                <td> <a href="#" class="edit" data-id="<?php echo $item['Department']['id']; ?>"><i class="fa fa-edit"> </i> Edit</a> - <a href="#" class="remove" data-id="<?php echo $item['Department']['id']; ?>"><i class="fa fa-remove"> </i> Remove</a></td>
	            </tr>
			<?php } ?>
		</tbody>
	</table>
    <?php if($this->params['paging']['Department']['pageCount'] > 1) { ?>
        <ul class="pagination">
            <?php
